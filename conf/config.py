...
POOL_TARGET = 131071                # Pool-wide difficulty target int >= 1

COIND_RPC_HOST = os.getenv('COIND_RPC_HOST', 'localhost')
COIND_RPC_PORT = int(os.getenv('COIND_RPC_PORT',  8332))
COIND_RPC_USER = os.getenv('COIND_RPC_USER', '1')
COIND_RPC_PASS = os.getenv('COIND_RPC_PASS', 'x')

COIND_ALGO = os.getenv('COIND_ALGO', 'auto')
